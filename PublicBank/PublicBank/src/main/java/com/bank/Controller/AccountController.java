...
public class AccountController {
    ...
    public ResponseEntity<Object> updateAccountBalance(@PathVariable int id ,@RequestBody AccountDTO accountDTO){
        boolean a = accountImple.updateAccountBlance(id,accountDTO);
